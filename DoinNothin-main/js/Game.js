    ...
    showTutorial(type = 'night1') {
        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                <h2>JÓNÁS ELLENI VÉDEKEZÉS</h2>
                <p>
                    JÓNÁS A CAM1 ÉS CAM2-NÉL LÉVŐ SZELLŐZŐKBŐL TÁMAD. HA DÖMBÖLÉST HALLASZ A JÓZSI TABLETNÉL CSUKD BE A SZELLŐZŐKET. 
                    BEZÁRÁS UTÁN HA MEGINT DÖRÖMBÖLÉST HALLASZ AKKOR ELMENT. HA TÚL SOKÁIG CSUKVA TARTOD A SZELLŐZŐT A JOBB LENTI SZÁZALÉK KEMEGY ÉS MEGFULLADSZ. 
                   JÓNÁST IS EL CSALHATOD A CSALIKKAL DE INKÁBB ERIKÁRA HASZNÁLD.
                </p>
            ...
            // Night 3 教程：霍金
            tutorialContent.innerHTML = `
                <h2>IGAZGATÓ(FINAL BOSS)</h2>
                <p>
                    AZ IGAZGATÓ CAM 6-NÁL INDUL ÉS GYÜLÖLI A GYEREKEKET. 
                    BAZD AGYON ÁRAMMAL HOGY EGY HELYBE MARADJON.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>VÉDD MEG MAGAD ERIKA ELLEN ERIKA</h2>
                <p>
                    ERIKA MINDIG CAM 11-NÉL INDUL. HASZNÁLD A CSALI HANGOKAT HOGY ELHÚZD MAGADTÓL.
                    ERIKA CSAK AKKOR MEGY A CSALIHOZ HA A MELLETTE LÉVŐ KAMERÁHOZ RAKTAD.
                    NEM FOG MŰKÖDNI HA SOKSZOR EGY HELYRE RAKOD EGYMÁS UTÁN.
                    HA SOK CSALIT HASZNÁLSZ HIBÁSSÁ VÁLIK A KAMERA.
                    AHOZ HOGY MEGJAVÍTSD A KAMERÁKAT BAL LENT FEL KELL NYITNOD A JÓZSI TABLETET ÉS A         
MÁSODIK GOMBOT NYOMD MEG.
                    ERIKA NEM HASZNÁLJA A SZELLŐZŐKET TEHÁT NE FOGLALKOZZ VELÜK.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
